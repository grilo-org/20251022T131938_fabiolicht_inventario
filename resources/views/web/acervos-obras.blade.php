...
@section('titulo', 'Obras do Acervo')	
@section('content')
    ...
    <div class="align-center container-fluid">
        <div class="row">
            <div class="col-12 col-lg-12">
                <h1 class="mbr-section-title mbr-fonts-style align-center mbr-white display-2"><br><br>Obras</h1>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="col-md-3 img-card mt-3">
                            <div class="img-block">
                                <div class="wrapper-img">
                                    <a href="#">
                                        <img src="{{ $obra->foto_frontal_obra ? url($obra->foto_frontal_obra) : '' }}" alt="{{$obra->titulo_obra}}">
                                    </a>
                                    <div class="title-block">
                                        <a href="#">
                                        <h4 class="mbr-fonts-style signature mbr-bold display-4">{{$obra->titulo_obra}}</h4>
                                        </a>
                                        <div class="card-icon">
